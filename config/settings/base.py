...
AUTHENTICATION_BACKENDS = [
    ...
    'todo.auth.oidc.KeycloakOIDCBackend',
...
KEYCLOAK_REALM = env('KEYCLOAK_REALM', default='todo-realm')
KEYCLOAK_CLIENT_ID = env('KEYCLOAK_CLIENT_ID', default='todo-client')
KEYCLOAK_CLIENT_SECRET = env('KEYCLOAK_CLIENT_SECRET', default='your-client-secret')
KEYCLOAK_REDIRECT_URI = env('KEYCLOAK_REDIRECT_URI', default='http://localhost:8000/auth/callback/')
